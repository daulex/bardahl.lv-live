...
<div class="seopress-notice">
    <p><?php /* translators: %1$s: get_home_url() */ printf(__('A <strong>robots.txt file</strong> lives at the root of your site. So, for site %1$s, the robots.txt file lives at %1$s/robots.txt.', 'wp-seopress-pro'), get_home_url()); ?>
    </p>
