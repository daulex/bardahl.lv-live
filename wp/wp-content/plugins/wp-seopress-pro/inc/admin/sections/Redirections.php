...
<div class="seopress-notice">
    ...
    <p>
        ...
        <a href="<?php echo admin_url('edit.php?post_type=seopress_404&action=-1&m=0&redirect-cat=0&redirection-type=404&redirection-enabled&filter_action=Filter&paged=1&action2=-1&post_status=404'); ?>" class="btn btnTertiary">
