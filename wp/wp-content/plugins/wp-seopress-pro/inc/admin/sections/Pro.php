...
function print_pro_section($key)
{
    ...
    $sections = [
        ...
        'rich-snippets'=> [
            ...
            'desc'   => /* translators: %s documentation URL */ sprintf(__('Add Structured Data Types support, mark your content, and get better Google Search Results. <span class="seopress-help dashicons dashicons-external"></span><a class="seopress-help" href="%s" target="_blank">Learn More</a>', 'wp-seopress-pro'), $docs['schemas']['ebook']),
        ],
        'page-speed'=> [
        ...
        'rss'=> [
            ...
            'desc'  => /* translators: %s home URL */ sprintf(__('Configure WordPress default feeds. <br><br><a href="%s" class="btn btnTertiary" target="_blank">View my RSS feed</a>', 'wp-seopress-pro'), get_home_url() . '/feed'),
        ],
        'rewrite'=> [
            'toggle' => 1,
            'title'  => __('Rewrite', 'wp-seopress-pro'),
            'desc'   => /* translators: %s admin URL of SEOPress advanced settings page */ sprintf(__('Change the URL rewriting. To remove the <strong>/category/</strong> or <strong>/product-category/</strong> in URL, <a href="%s">click here</a>.', 'wp-seopress-pro'), admin_url('admin.php?page=seopress-advanced')),
        ],
        'white-label'=> [
            'toggle' => 1,
