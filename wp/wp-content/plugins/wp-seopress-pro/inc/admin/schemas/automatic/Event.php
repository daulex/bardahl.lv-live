...
<div class="wrap-rich-snippets-events">
    ...
    <p>
        ...
        <span class="description"><?php _e('e.g. YYYY-MM-DD', 'wp-seopress-pro'); ?></span>
    </p>
    <p>
        ...
        <span class="description"><?php _e('e.g. -4:00', 'wp-seopress-pro'); ?></span>
    </p>
    <p>
        ...
        <span class="description"><?php _e('e.g. HH:MM', 'wp-seopress-pro'); ?></span>
    </p>
    <p>
    ...
    <p>
        ...
        <span class="description"><?php _e('e.g. My Local Business name', 'wp-seopress-pro'); ?></span>
    </p>
    <p>
        <label for="seopress_pro_rich_snippets_events_location_url_meta">
            <?php _e('Event website', 'wp-seopress-pro'); ?></label>
        <?php echo seopress_schemas_mapping_array('seopress_pro_rich_snippets_events_location_url', ['default', 'events']); ?>
        <span class="description"><?php _e('e.g. https://www.example.com', 'wp-seopress-pro'); ?></span>
    </p>
    <p>
        ...
        <span class="description"><?php _e('e.g. 1 Avenue de l\'Imperatrice, 64200 Biarritz', 'wp-seopress-pro'); ?></span>
    </p>
    <p>
        ...
        <span class="description"><?php _e('e.g. General admission', 'wp-seopress-pro'); ?></span>
    </p>
    <p>
    ...
    <p>
        ...
        <span class="description"><?php _e('e.g. 10', 'wp-seopress-pro'); ?></span>
    </p>
    <p>
        ...
        <span class="description"><?php _e('e.g. USD, EUR...', 'wp-seopress-pro'); ?></span>
    </p>
    <p>
        ...
        <span class="description"><?php _e('e.g. InStock, SoldOut, PreOrder', 'wp-seopress-pro'); ?></span>
    </p>
    <p>
    ...
    <p>
        ...
        <span class="description"><?php _e('e.g. Lana Del Rey', 'wp-seopress-pro'); ?></span>
    </p>
    <p>
        ...
        <span class="description"><?php _e('e.g. Apple', 'wp-seopress-pro'); ?></span>
    </p>
    <p>
