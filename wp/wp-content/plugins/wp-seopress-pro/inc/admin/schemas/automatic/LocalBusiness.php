...
<div class="wrap-rich-snippets-local-business">
    ...
    <p>
        ...
        <span class="description"><?php _e('e.g. My Local Business', 'wp-seopress-pro'); ?></span>
    </p>
    <p>
...
For best results, provide multiple high-resolution images (minimum of 50K pixels when multiplying width and height) with the following aspect ratios: 16x9, 4x3, and 1x1.', 'wp-seopress-pro'); ?>
    ...
    <p>
        ...
        <span class="description"><?php _e('e.g. Place Bellevue', 'wp-seopress-pro'); ?></span>
    </p>
    <p>
        ...
        <span class="description"><?php _e('e.g. Biarritz', 'wp-seopress-pro'); ?></span>
    </p>
    <p>
        ...
        <span class="description"><?php _e('e.g. Nouvelle Aquitaine', 'wp-seopress-pro'); ?></span>
    </p>
    <p>
        ...
        <span class="description"><?php _e('e.g. 64200', 'wp-seopress-pro'); ?></span>
    </p>
    <p>
        ...
        <span class="description"><?php _e('e.g. France', 'wp-seopress-pro'); ?></span>
    </p>
    <p>
        ...
        <span class="description"><?php _e('e.g. 43.4831389', 'wp-seopress-pro'); ?></span>
    </p>
    <p>
        ...
        <span class="description"><?php _e('e.g. -1.5630987', 'wp-seopress-pro'); ?></span>
    </p>
    <p>
        ...
        <span class="description"><?php _e('e.g. ', 'wp-seopress-pro') . get_home_url(); ?></span>
    </p>
    <p>
        ...
        <span class="description"><?php _e('e.g. +33501020304', 'wp-seopress-pro'); ?></span>
    </p>
    <p>
        ...
        <span class="description"><?php _e('e.g. $$, €€€, or ££££...', 'wp-seopress-pro'); ?></span>
    </p>
    <p>
    ...
    <p>
        ...
        <span class="description"><?php _e('<strong>Morning and Afternoon are just time slots</strong>. e.g. if you\'re opened from 10:00 AM to 9:00 PM, check Morning and enter 10:00 / 21:00. If you are open non-stop, check Morning and enter 0:00 / 23:59.', 'wp-seopress-pro'); ?></span>
    </p>
