...
<div class="wrap-rich-snippets-recipes">
    ...
    <p>
        ...
        <span class="description"><?php _e('e.g. appetizer, entree, or dessert', 'wp-seopress-pro'); ?></span>
    </p>
    <p>
    ...
    <p>
        ...
        <span class="description"><?php _e('e.g. 30 min', 'wp-seopress-pro'); ?></span>
    </p>
    <p>
        ...
        <span class="description"><?php _e('e.g. 45 min', 'wp-seopress-pro'); ?></span>
    </p>
    <p>
    ...
    <p>
        ...
        <span class="description"><?php _e('e.g. number of people served, or number of servings', 'wp-seopress-pro'); ?></span>
    </p>
    <p>
        ...
        <span class="description"><?php _e('e.g. winter apple pie, nutmeg crust (NOT recommended: dessert, American)', 'wp-seopress-pro'); ?></span>
    </p>
    <p>
    ...
    <p>
        ...
        <span class="description"><?php _e('e.g. Heat oven to 425°F. Include only text on how to make the recipe and don\'t include other text such as "Directions", "Watch the video", "Step 1".', 'wp-seopress-pro'); ?></span>
    </p>
</div>
