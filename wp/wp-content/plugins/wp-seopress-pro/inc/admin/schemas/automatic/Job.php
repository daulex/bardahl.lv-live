...
<div class="wrap-rich-snippets-jobs">
    ...
    <p>
        ...
        <span class="description"><?php _e('e.g. 50.00', 'wp-seopress-pro'); ?></span>
    </p>
    <p>
        ...
        <span class="description"><?php _e('e.g. USD', 'wp-seopress-pro'); ?></span>
    </p>
    <p>
