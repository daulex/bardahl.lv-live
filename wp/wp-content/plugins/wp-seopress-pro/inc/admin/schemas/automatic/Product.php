        ...
        if (is_plugin_active('woocommerce/woocommerce.php')) {
            ...
            { ?>
                ...
                <p>
                    ...
                    <span class="description"><?php _e('e.g. 30', 'wp-seopress-pro'); ?></span>
                </p>
                <p>
                ...
                <p>
                    ...
                    <span class="description"><?php _e('e.g. 0446310786', 'wp-seopress-pro'); ?></span>
                </p>
                <p>
                    ...
                    <span class="description"><?php _e('e.g. gtin8', 'wp-seopress-pro'); ?></span>
                </p>
                <p>
                    ...
                    <span class="description"><?php _e('e.g. 925872', 'wp-seopress-pro'); ?></span>
                </p>
                <p>
                ...
                <p>
                    <label for="seopress_pro_rich_snippets_product_energy_consumption"><?php _e('Energy Consumption', 'wp-seopress-pro'); ?></label>
