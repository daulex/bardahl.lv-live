...
<div class="wrap-rich-snippets-item wrap-rich-snippets-recipes">
    ...
    <p>
        ...
        <input type="text" id="seopress_pro_rich_snippets_recipes_cat_meta"
            ...
            placeholder="<?php echo esc_html__('e.g. appetizer, entree, or dessert', 'wp-seopress-pro'); ?>"
    ...
    <p>
        ...
        <input type="text" id="seopress_pro_rich_snippets_recipes_video_meta"
            ...
            placeholder="<?php echo esc_html__('e.g. https://www.youtube.com/watch?v=p6v9Jd5lRIU', 'wp-seopress-pro'); ?>"
    ...
    <p>
        ...
        <input type="number" id="seopress_pro_rich_snippets_recipes_prep_time_meta"
            ...
            placeholder="<?php echo esc_html__('e.g. 30 min', 'wp-seopress-pro'); ?>"
    ...
    <p>
        ...
        <input type="number" id="seopress_pro_rich_snippets_recipes_cook_time_meta"
            ...
            placeholder="<?php echo esc_html__('e.g. 45 min', 'wp-seopress-pro'); ?>"
    ...
    <p>
        ...
        <input type="text" id="seopress_pro_rich_snippets_recipes_yield_meta"
            ...
            placeholder="<?php echo esc_html__('e.g. number of people served, or number of servings', 'wp-seopress-pro'); ?>"
    ...
    <p>
        ...
        <input type="text" id="seopress_pro_rich_snippets_recipes_keywords_meta"
            ...
            placeholder="<?php echo esc_html__('e.g. winter apple pie, nutmeg crust (NOT recommended: dessert, American)', 'wp-seopress-pro'); ?>"
    ...
    <p>
        ...
        <textarea rows="12" id="seopress_pro_rich_snippets_recipes_instructions_meta"
            ...
            placeholder="<?php echo esc_html__('e.g. Heat oven to 425°F. Include only text on how to make the recipe and don\'t include other text such as "Directions", "Watch the video", "Step 1".', 'wp-seopress-pro'); ?>"
