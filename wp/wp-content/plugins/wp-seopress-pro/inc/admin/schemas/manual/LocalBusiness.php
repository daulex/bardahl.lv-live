...
<div class="wrap-rich-snippets-item wrap-rich-snippets-local-business">
    ...
    <p>
        ...
        <input type="text" id="seopress_pro_rich_snippets_lb_name_meta"
            ...
            placeholder="<?php echo esc_html__('e.g. My Local Business', 'wp-seopress-pro'); ?>"
    ...
    <p>
        ...
        <input type="text" id="seopress_pro_rich_snippets_lb_state_meta"
            ...
            placeholder="<?php echo esc_html__('e.g. Nouvelle Aquitaine', 'wp-seopress-pro'); ?>"
    ...
    <p>
        ...
        <input type="text" id="seopress_pro_rich_snippets_lb_pc_meta"
            ...
            placeholder="<?php echo esc_html__('e.g. 64200', 'wp-seopress-pro') . '" aria-label="' . __('Postal code', 'wp-seopress-pro'); ?>"
    ...
    <p>
        ...
        <input type="text" id="seopress_pro_rich_snippets_lb_country_meta"
            ...
            placeholder="<?php echo esc_html__('e.g. France', 'wp-seopress-pro'); ?>"
    ...
    <p>
        ...
        <input type="text" id="seopress_pro_rich_snippets_lb_lon_meta"
            ...
            placeholder="<?php echo esc_html__('e.g. -1.5630987', 'wp-seopress-pro'); ?>"
    ...
    <p>
        ...
        <input type="text" id="seopress_pro_rich_snippets_lb_website_meta"
            ...
            placeholder="<?php /* translators: %s home_url() */ printf(esc_html__('e.g. %s', 'wp-seopress-pro'), get_home_url()); ?>"
    ...
    <p>
        ...
        <input type="text" id="seopress_pro_rich_snippets_lb_cuisine_meta"
            ...
            placeholder="<?php echo esc_html__('e.g. French, Italian, Indian, American', 'wp-seopress-pro'); ?>"
