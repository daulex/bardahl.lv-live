...
class SEOPRESS_CSV_Importers {
	...
	public function admin_scripts() {
		...
		if (isset($_GET['page']) && ($_GET['page'] == 'seopress_csv_importer') ) {
			wp_register_script( 'seopress-csv-import', plugins_url( 'assets/js/seopress-csv-import' . $prefix . '.js', dirname(dirname(dirname(__FILE__)))), array( 'jquery' ), SEOPRESS_VERSION, true );
		}
	}
