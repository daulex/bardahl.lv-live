...
function seopress_ps_api_key_callback() {
    ...
    <p class="seopress-help description">
        <?php
            ...
            printf(__('<span class="dashicons dashicons-external"></span><a href="%s" target="_blank">A Page Speed Insights key</a> is required to avoid quota errors.', 'wp-seopress-pro'), esc_url($docs['page_speed']['google']));
        ?>
    </p>
