...
<p class="description seopress-help">
    <?php
        ...
        printf(__('Your video sitemap is empty? Read our guide to learn more about <a href="%s" target="_blank">adding videos to your sitemap.</a>', 'wp-seopress-pro'), $docs['sitemaps']['video']);
    ?>
</p>
<p class="description">
...
<p class="description">
    <?php
        /* translators: %s: documentation URL */
        printf(__('<a href="%s">Regenerate automatic XML Video sitemap for YouTube?</a>', 'wp-seopress-pro'), admin_url('admin.php?page=seopress-import-export#tab=tab_seopress_tool_video'));
    ?>
</p>
