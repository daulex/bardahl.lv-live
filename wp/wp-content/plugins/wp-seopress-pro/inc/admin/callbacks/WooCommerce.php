...
<p class="description">
    <?php _e('If your theme or plugin displays the cart across your entire WordPress site, don\'t enable this option.', 'wp-seopress-pro'); ?>
</p>
...
<p class="description">
    <?php
        ...
        printf(__('The default product schema added by WooCommerce generates errors in Google Search Console. Disable it and create your own <a href="%s">automatic product schema</a>.', 'wp-seopress-pro'), esc_url(admin_url('edit.php?post_type=seopress_schemas')));
    ?>
</p>
