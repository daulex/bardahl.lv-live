...
function seopress_breadcrumbs_separator_callback() {
    ...
    printf(
        '<input type="text" class="seopress_breadcrumbs_sep" name="seopress_pro_option_name[seopress_breadcrumbs_separator]" aria-label="' . __('Breadcrumbs Separator', 'wp-seopress-pro') . '" placeholder="' . esc_html__('e.g. / ', 'wp-seopress-pro') . '" value="%s" />',
        esc_html($check)
    ); ?>
...
function seopress_breadcrumbs_i18n_here_callback() {
    ...
    printf(
        '<input type="text" name="seopress_pro_option_name[seopress_breadcrumbs_i18n_here]" aria-label="' . __('e.g. You are here: ', 'wp-seopress-pro') . '" placeholder="' . esc_html__('e.g. You are here: ', 'wp-seopress-pro') . '" value="%s" />',
        esc_html($check)
    ); ?>

<p class="description">
    <?php _e('HTML tags allowed, e.g. <code>span</code>, <code>p</code>...', 'wp-seopress-pro'); ?>
</p>
...
<label for="seopress_breadcrumbs_separator_disable">
    ...
    <?php } ?>
    value="1"/>
    <?php _e('My theme is already displaying a separator in my breadcrumbs', 'wp-seopress-pro'); ?>
</label>
