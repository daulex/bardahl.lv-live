...
function seopress_pro_titles_title_input_before($pagenow) {
    if ('1' == seopress_get_toggle_option('ai')) {
        ...
        <span class="seopress-d-flex">
            ...
            <button class="seopress_ai_generate_seo_meta <?php echo seopress_btn_secondary_classes(); ?>" data-lang="<?php if (function_exists('seopress_get_current_lang')) { echo seopress_get_current_lang(); }; ?>" data_meta="title" type="button"><?php _e('Generate meta title with AI','wp-seopress-pro'); ?></button>
        </span>
    <?php }
    }
}
...
function seopress_pro_titles_meta_desc_input_before($pagenow) {
    if ('1' == seopress_get_toggle_option('ai')) {
        ...
        <span class="seopress-d-flex">
            <span class="spinner"></span>
            <button class="seopress_ai_generate_seo_meta <?php echo seopress_btn_secondary_classes(); ?>" data-lang="<?php if (function_exists('seopress_get_current_lang')) { echo seopress_get_current_lang(); }; ?>" data_meta="desc" type="button"><?php _e('Generate meta description with AI','wp-seopress-pro'); ?></button>
        </span>
    <?php }
    }
}
                        ...
                        <div class="accordion-section-content">
                            ...
                            <p class="internal_video">
                                <label
                                    ...
                                    />
                                    <?php _e('NOT an external video (e.g. video hosting on YouTube, Vimeo, Wistia...)? Check this if your video is hosting on this server.', 'wp-seopress-pro'); ?>
                                </label>
                            </p>
                            <p>
                                <label
...
function seopress_pro_titles_title_tab_after($pagenow, $data_attr) {
    ...
    <p>
        <input id="seopress_robots_breadcrumbs_meta" type="text" name="seopress_robots_breadcrumbs"
            class="components-text-control__input"
            placeholder="<?php /* translators: %s: default post title */ esc_html_e(sprintf(__('Current breadcrumbs: %s', 'wp-seopress-pro'), $data_attr['title'])); ?>"
