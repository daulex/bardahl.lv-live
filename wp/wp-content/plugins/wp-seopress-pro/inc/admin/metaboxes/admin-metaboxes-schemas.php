        ...
        if ('articles' == $seopress_pro_rich_snippets_type) {
            ...
            if ('manual_date_single' == $seopress_pro_rich_snippets_article_coverage_start_date) {
                echo '<p>
						...
						<input type="text" class="seopress-date-picker" id="seopress_pro_schemas[' . $id . '][rich_snippets_article][coverage_start_date]" name="seopress_pro_schemas[' . $id . '][rich_snippets_article][coverage_start_date]" placeholder="' . esc_html__('e.g. YYYY-MM-DD', 'wp-seopress-pro') . '" aria-label="' . __('Coverage Start Date', 'wp-seopress-pro') . '" value="' . esc_html($check_article_coverage_start_date) . '" />
					</p>';
            }
            if ('manual_time_single' == $seopress_pro_rich_snippets_article_coverage_start_time) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_article][coverage_start_time]" name="seopress_pro_schemas[' . $id . '][rich_snippets_article][coverage_start_time]" placeholder="' . esc_html__('e.g. HH:MM', 'wp-seopress-pro') . '" aria-label="' . __('Coverage Start Time', 'wp-seopress-pro') . '" value="' . esc_html($check_article_coverage_start_time) . '" />
					</p>';
            }
            if ('manual_date_single' == $seopress_pro_rich_snippets_article_coverage_end_date) {
                echo '<p>
						...
						<input type="text" class="seopress-date-picker" id="seopress_pro_schemas[' . $id . '][rich_snippets_article][coverage_end_date]" name="seopress_pro_schemas[' . $id . '][rich_snippets_article][coverage_end_date]" placeholder="' . esc_html__('e.g. YYYY-MM-DD', 'wp-seopress-pro') . '" aria-label="' . __('Coverage End Date', 'wp-seopress-pro') . '" value="' . esc_html($check_article_coverage_end_date) . '" />
					</p>';
            }
            if ('manual_time_single' == $seopress_pro_rich_snippets_article_coverage_end_time) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_article][coverage_end_time]" name="seopress_pro_schemas[' . $id . '][rich_snippets_article][coverage_end_time]" placeholder="' . esc_html__('e.g. HH:MM', 'wp-seopress-pro') . '" aria-label="' . __('Coverage End Time', 'wp-seopress-pro') . '" value="' . esc_html($check_article_coverage_end_time) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_article_speakable) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_article][speakable]" name="seopress_pro_schemas[' . $id . '][rich_snippets_article][speakable]" placeholder="' . esc_html__('e.g. post', 'wp-seopress-pro') . '" aria-label="' . __('Speakable CSS Selector', 'wp-seopress-pro') . '" value="' . esc_html($check_article_speakable) . '" />
					</p>';
            }
        }
        ...
        if ('localbusiness' == $seopress_pro_rich_snippets_type) {
            if ('manual_single' == $seopress_pro_rich_snippets_lb_name) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_lb][name]" name="seopress_pro_schemas[' . $id . '][rich_snippets_lb][name]" placeholder="' . esc_html__('e.g. My Local Business', 'wp-seopress-pro') . '" aria-label="' . __('Name of your business', 'wp-seopress-pro') . '" value="' . esc_html($check_lb_name) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_lb_type) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_lb][type]" name="seopress_pro_schemas[' . $id . '][rich_snippets_lb][type]" placeholder="' . esc_html__('e.g. TravelAgency', 'wp-seopress-pro') . '" aria-label="' . __('Select a business type', 'wp-seopress-pro') . '" value="' . esc_html($check_lb_type) . '" />
					</p>';
            }
            ...
            if ('manual_single' == $seopress_pro_rich_snippets_lb_street_addr) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_lb][street_addr]" name="seopress_pro_schemas[' . $id . '][rich_snippets_lb][street_addr]" placeholder="' . esc_html__('e.g. Place Bellevue', 'wp-seopress-pro') . '" aria-label="' . __('Street Address', 'wp-seopress-pro') . '" value="' . esc_html($check_lb_street_addr) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_lb_city) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_lb][city]" name="seopress_pro_schemas[' . $id . '][rich_snippets_lb][city]" placeholder="' . esc_html__('e.g. Biarritz', 'wp-seopress-pro') . '" aria-label="' . __('City', 'wp-seopress-pro') . '" value="' . esc_html($check_lb_city) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_lb_state) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_lb][state]" name="seopress_pro_schemas[' . $id . '][rich_snippets_lb][state]" placeholder="' . esc_html__('e.g. Nouvelle Aquitaine', 'wp-seopress-pro') . '" aria-label="' . __('State', 'wp-seopress-pro') . '" value="' . esc_html($check_lb_state) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_lb_pc) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_lb][pc]" name="seopress_pro_schemas[' . $id . '][rich_snippets_lb][pc]" placeholder="' . esc_html__('e.g. 64200', 'wp-seopress-pro') . '" aria-label="' . __('Postal code', 'wp-seopress-pro') . '" value="' . esc_html($check_lb_pc) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_lb_country) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_lb][country]" name="seopress_pro_schemas[' . $id . '][rich_snippets_lb][country]" placeholder="' . esc_html__('e.g. France', 'wp-seopress-pro') . '" aria-label="' . __('Country', 'wp-seopress-pro') . '" value="' . esc_html($check_lb_country) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_lb_lat) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_lb][lat]" name="seopress_pro_schemas[' . $id . '][rich_snippets_lb][lat]" placeholder="' . esc_html__('e.g. 43.4831389', 'wp-seopress-pro') . '" aria-label="' . __('Latitude', 'wp-seopress-pro') . '" value="' . esc_html($check_lb_lat) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_lb_lon) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_lb][lon]" name="seopress_pro_schemas[' . $id . '][rich_snippets_lb][lon]" placeholder="' . esc_html__('e.g. -1.5630987', 'wp-seopress-pro') . '" aria-label="' . __('Longitude', 'wp-seopress-pro') . '" value="' . esc_html($check_lb_lon) . '" />
					</p>';
            }
            ...
            if ('manual_single' == $seopress_pro_rich_snippets_lb_tel) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_lb][tel]" name="seopress_pro_schemas[' . $id . '][rich_snippets_lb][tel]" placeholder="' . esc_html__('e.g. +33501020304', 'wp-seopress-pro') . '" aria-label="' . __('Telephone', 'wp-seopress-pro') . '" value="' . esc_html($check_lb_tel) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_lb_price) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_lb][price]" name="seopress_pro_schemas[' . $id . '][rich_snippets_lb][price]" placeholder="' . esc_html__('e.g. $$, €€€, or ££££...', 'wp-seopress-pro') . '" aria-label="' . __('Price range', 'wp-seopress-pro') . '" value="' . esc_html($check_lb_price) . '" />
					</p>';
            }
            echo '<p>
        ...
        if ('recipes' == $seopress_pro_rich_snippets_type) {
            ...
            if ('manual_single' == $seopress_pro_rich_snippets_recipes_cat) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_recipes][cat]" name="seopress_pro_schemas[' . $id . '][rich_snippets_recipes][cat]" placeholder="' . esc_html__('e.g. appetizer, entree, or dessert', 'wp-seopress-pro') . '" aria-label="' . __('Recipe category', 'wp-seopress-pro') . '" value="' . esc_html($check_recipes_cat) . '" />
					</p>';
            }
            ...
            if ('manual_single' == $seopress_pro_rich_snippets_recipes_prep_time) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_recipes][prep_time]" name="seopress_pro_schemas[' . $id . '][rich_snippets_recipes][prep_time]" placeholder="' . esc_html__('e.g. 30', 'wp-seopress-pro') . '" aria-label="' . __('Preparation time (in minutes)', 'wp-seopress-pro') . '" value="' . esc_html($check_recipes_prep_time) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_recipes_cook_time) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_recipes][cook_time]" name="seopress_pro_schemas[' . $id . '][rich_snippets_recipes][cook_time]" placeholder="' . esc_html__('e.g. 45', 'wp-seopress-pro') . '" aria-label="' . __('Cooking time (in minutes)', 'wp-seopress-pro') . '" value="' . esc_html($check_recipes_cook_time) . '" />
					</p>';
            }
            ...
            if ('manual_single' == $seopress_pro_rich_snippets_recipes_yield) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_recipes][yield]" name="seopress_pro_schemas[' . $id . '][rich_snippets_recipes][yield]" placeholder="' . esc_html__('e.g. number of people served, or number of servings', 'wp-seopress-pro') . '" aria-label="' . __('Recipe yield', 'wp-seopress-pro') . '" value="' . esc_html($check_recipes_yield) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_recipes_keywords) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_recipes][keywords]" name="seopress_pro_schemas[' . $id . '][rich_snippets_recipes][keywords]" placeholder="' . esc_html__('e.g. winter apple pie, nutmeg crust (NOT recommended: dessert, American)', 'wp-seopress-pro') . '" aria-label="' . __('Keywords', 'wp-seopress-pro') . '" value="' . esc_html($check_recipes_keywords) . '" />
					</p>';
            }
            ...
            if ('manual_single' == $seopress_pro_rich_snippets_jobs_location_requirement) {
                echo '<p>
                    <label for="seopress_pro_schemas[' . $id . '][rich_snippets_jobs][location_requirement]_meta">
                        ' . __('Location requirement for remote job', 'wp-seopress-pro') . '</label>
                    <input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_jobs][location_requirement]" name="seopress_pro_schemas[' . $id . '][rich_snippets_jobs][location_requirement]" placeholder="' . esc_html__('Location requirement for remote job', 'wp-seopress-pro') . '" aria-label="' . __('Location requirement for remote job', 'wp-seopress-pro') . '" value="' . esc_html($check_jobs_location_requirement) . '" />
                </p>';
            }
        ...
        if ('videos' == $seopress_pro_rich_snippets_type) {
            ...
            if ('manual_date_single' == $seopress_pro_rich_snippets_videos_date_posted) {
                echo '<p>
						<label for="seopress_pro_schemas[' . $id . '][rich_snippets_videos][date_posted]_meta">
							' . __('Uploaded date', 'wp-seopress-pro') . '</label>
            ...
            if ('manual_single' == $seopress_pro_rich_snippets_videos_url) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_videos][url]" name="seopress_pro_schemas[' . $id . '][rich_snippets_videos][url]" placeholder="' . esc_html__('e.g. https://example.com/video.mp4', 'wp-seopress-pro') . '" aria-label="' . __('Video URL', 'wp-seopress-pro') . '" value="' . esc_html($check_videos_url) . '" />
					</p>';
            }
        }
        ...
        if ('events' == $seopress_pro_rich_snippets_type) {
            ...
            if ('manual_date_single' == $seopress_pro_rich_snippets_events_start_date) {
                echo '<p>
						...
						<input type="text" class="seopress-date-picker" id="seopress_pro_schemas[' . $id . '][rich_snippets_events][start_date]" name="seopress_pro_schemas[' . $id . '][rich_snippets_events][start_date]" placeholder="' . esc_html__('e.g. YYYY-MM-DD', 'wp-seopress-pro') . '" aria-label="' . __('Start date', 'wp-seopress-pro') . '" value="' . esc_html($check_events_start_date) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_events_start_date_timezone) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_events][start_date_timezone]" name="seopress_pro_schemas[' . $id . '][rich_snippets_events][start_date_timezone]" placeholder="' . esc_html__('e.g. -4:00', 'wp-seopress-pro') . '" aria-label="' . __('Timezone start date', 'wp-seopress-pro') . '" value="' . esc_html($check_events_start_date_timezone) . '" />
					</p>';
            }
            if ('manual_time_single' == $seopress_pro_rich_snippets_events_start_time) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_events][start_time]" name="seopress_pro_schemas[' . $id . '][rich_snippets_events][start_time]" placeholder="' . esc_html__('e.g. HH:MM', 'wp-seopress-pro') . '" aria-label="' . __('Start time', 'wp-seopress-pro') . '" value="' . esc_html($check_events_start_time) . '" />
					</p>';
            }
            if ('manual_date_single' == $seopress_pro_rich_snippets_events_end_date) {
                echo '<p>
						...
						<input type="text" class="seopress-date-picker" id="seopress_pro_schemas[' . $id . '][rich_snippets_events][end_date]" name="seopress_pro_schemas[' . $id . '][rich_snippets_events][end_date]" placeholder="' . esc_html__('e.g. YYYY-MM-DD', 'wp-seopress-pro') . '" aria-label="' . __('End date', 'wp-seopress-pro') . '" value="' . esc_html($check_events_end_date) . '" />
					</p>';
            }
            if ('manual_time_single' == $seopress_pro_rich_snippets_events_end_time) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_events][end_time]" name="seopress_pro_schemas[' . $id . '][rich_snippets_events][end_time]" placeholder="' . esc_html__('e.g. HH:MM', 'wp-seopress-pro') . '" aria-label="' . __('End time', 'wp-seopress-pro') . '" value="' . esc_html($check_events_end_time) . '" />
					</p>';
            }
            if ('manual_date_single' == $seopress_pro_rich_snippets_events_previous_start_date) {
                echo '<p>
						...
						<input type="text" class="seopress-date-picker" id="seopress_pro_schemas[' . $id . '][rich_snippets_events][previous_start_date]" name="seopress_pro_schemas[' . $id . '][rich_snippets_events][previous_start_date]" placeholder="' . esc_html__('e.g. YYYY-MM-DD', 'wp-seopress-pro') . '" aria-label="' . __('Previous start date', 'wp-seopress-pro') . '" value="' . esc_html($check_events_previous_start_date) . '" />
					</p>';
            }
            if ('manual_time_single' == $seopress_pro_rich_snippets_events_previous_start_time) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_events][previous_start_time]" name="seopress_pro_schemas[' . $id . '][rich_snippets_events][previous_start_time]" placeholder="' . esc_html__('e.g. HH:MM', 'wp-seopress-pro') . '" aria-label="' . __('Previous start time', 'wp-seopress-pro') . '" value="' . esc_html($check_events_previous_start_time) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_events_location_name) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_events][location_name]" name="seopress_pro_schemas[' . $id . '][rich_snippets_events][location_name]" placeholder="' . esc_html__('e.g. My Local Business name', 'wp-seopress-pro') . '" aria-label="' . __('Location name', 'wp-seopress-pro') . '" value="' . esc_html($check_events_location_name) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_events_location_url) {
                echo '<p>
						<label for="seopress_pro_schemas[' . $id . '][rich_snippets_events][location_url]_meta">
							' . __('Event website', 'wp-seopress-pro') . '</label>
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_events][location_url]" name="seopress_pro_schemas[' . $id . '][rich_snippets_events][location_url]" placeholder="' . esc_html__('e.g. https://www.example.com', 'wp-seopress-pro') . '" aria-label="' . __('Event website', 'wp-seopress-pro') . '" value="' . esc_html($check_events_location_url) . '" />
					</p>';
            }
            ...
            if ('manual_single' == $seopress_pro_rich_snippets_events_offers_name) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_events][offers_name]" name="seopress_pro_schemas[' . $id . '][rich_snippets_events][offers_name]" placeholder="' . esc_html__('e.g. General admission', 'wp-seopress-pro') . '" aria-label="' . __('Offer name', 'wp-seopress-pro') . '" value="' . esc_html($check_events_offers_name) . '" />
					</p>';
            }
            ...
            if ('manual_single' == $seopress_pro_rich_snippets_events_offers_price) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_events][offers_price]" name="seopress_pro_schemas[' . $id . '][rich_snippets_events][offers_price]" placeholder="' . esc_html__('e.g. 10', 'wp-seopress-pro') . '" aria-label="' . __('Offer price', 'wp-seopress-pro') . '" value="' . esc_html($check_events_offers_price) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_events_offers_price_currency) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_events][offers_price_currency]" name="seopress_pro_schemas[' . $id . '][rich_snippets_events][offers_price_currency]" placeholder="' . esc_html__('e.g. USD, EUR...', 'wp-seopress-pro') . '" aria-label="' . __('Offer price currency', 'wp-seopress-pro') . '" value="' . esc_html($check_events_offers_price_currency) . '" />
					</p>';
            }
            ...
            if ('manual_single' == $seopress_pro_rich_snippets_events_offers_url) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_events][offers_url]" name="seopress_pro_schemas[' . $id . '][rich_snippets_events][offers_url]" placeholder="' . esc_html__('e.g. https://www.example.com', 'wp-seopress-pro') . '" aria-label="' . __('Website to buy tickets', 'wp-seopress-pro') . '" value="' . esc_html($check_events_offers_url) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_events_performer) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_events][performer]" name="seopress_pro_schemas[' . $id . '][rich_snippets_events][performer]" placeholder="' . esc_html__('e.g. Lana Del Rey', 'wp-seopress-pro') . '" aria-label="' . __('Performer name', 'wp-seopress-pro') . '" value="' . esc_html($check_events_performer) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_events_organizer_name) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_events][organizer_name]" name="seopress_pro_schemas[' . $id . '][rich_snippets_events][organizer_name]" placeholder="' . esc_html__('e.g. Apple', 'wp-seopress-pro') . '" aria-label="' . __('Organizer name', 'wp-seopress-pro') . '" value="' . esc_html($check_events_organizer_name) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_events_organizer_url) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_events][organizer_url]" name="seopress_pro_schemas[' . $id . '][rich_snippets_events][organizer_url]" placeholder="' . esc_html__('e.g. https://www.example.com', 'wp-seopress-pro') . '" aria-label="' . __('Organizer URL', 'wp-seopress-pro') . '" value="' . esc_html($check_events_organizer_url) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_events_status) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_events][status]" name="seopress_pro_schemas[' . $id . '][rich_snippets_events][status]" placeholder="' . esc_html__('e.g. EventCancelled', 'wp-seopress-pro') . '" aria-label="' . __('Event status', 'wp-seopress-pro') . '" value="' . esc_html($check_events_status) . '" />
            ...
            if ('manual_single' == $seopress_pro_rich_snippets_events_attendance_mode) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_events][attendance_mode]" name="seopress_pro_schemas[' . $id . '][rich_snippets_events][attendance_mode]" placeholder="' . esc_html__('e.g. OfflineEventAttendanceMode', 'wp-seopress-pro') . '" aria-label="' . __('Event attendance mode', 'wp-seopress-pro') . '" value="' . esc_html($check_events_attendance_mode) . '" />
        ...
        if ('products' == $seopress_pro_rich_snippets_type) {
            ...
            if ('manual_single' == $seopress_pro_rich_snippets_product_price) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_product][price]" name="seopress_pro_schemas[' . $id . '][rich_snippets_product][price]" placeholder="' . esc_html__('e.g. 30', 'wp-seopress-pro') . '" aria-label="' . __('Product price', 'wp-seopress-pro') . '" value="' . esc_html($check_product_price) . '" />
            ...
            if ('manual_date_single' == $seopress_pro_rich_snippets_product_price_valid_date) {
                echo '<p>
						...
						<input type="text" class="seopress-date-picker" id="seopress_pro_schemas[' . $id . '][rich_snippets_product][price_valid_date]" name="seopress_pro_schemas[' . $id . '][rich_snippets_product][price_valid_date]" placeholder="' . esc_html__('e.g. YYYY-MM-DD', 'wp-seopress-pro') . '" aria-label="' . __('Product price valid until', 'wp-seopress-pro') . '" value="' . esc_html($check_product_price_valid_date) . '" />
            ...
            if ('manual_single' == $seopress_pro_rich_snippets_product_sku) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_product][sku]" name="seopress_pro_schemas[' . $id . '][rich_snippets_product][sku]" placeholder="' . esc_html__('e.g. 0446310786', 'wp-seopress-pro') . '" aria-label="' . __('Product SKU', 'wp-seopress-pro') . '" value="' . esc_html($check_product_sku) . '" />
            ...
            if ('manual_single' == $seopress_pro_rich_snippets_product_global_ids) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_product][global_ids]" name="seopress_pro_schemas[' . $id . '][rich_snippets_product][global_ids]" placeholder="' . esc_html__('e.g. gtin8', 'wp-seopress-pro') . '" aria-label="' . __('Product Global Identifiers type', 'wp-seopress-pro') . '" value="' . esc_html($check_product_global_ids) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_product_global_ids_value) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_product][global_ids_value]" name="seopress_pro_schemas[' . $id . '][rich_snippets_product][global_ids_value]" placeholder="' . esc_html__('e.g. 925872', 'wp-seopress-pro') . '" aria-label="' . __('Product Global Identifiers', 'wp-seopress-pro') . '" value="' . esc_html($check_product_global_ids_value) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_product_brand) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_product][brand]" name="seopress_pro_schemas[' . $id . '][rich_snippets_product][brand]" placeholder="' . esc_html__('e.g. category', 'wp-seopress-pro') . '" aria-label="' . __('Select a brand', 'wp-seopress-pro') . '" value="' . esc_html($check_product_brand) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_product_price_currency) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_product][currency]" name="seopress_pro_schemas[' . $id . '][rich_snippets_product][currency]" placeholder="' . esc_html__('e.g. USD, EUR', 'wp-seopress-pro') . '" aria-label="' . __('Product currency', 'wp-seopress-pro') . '" value="' . esc_html($check_product_currency) . '" />
            ...
            if ('manual_single' == $seopress_pro_rich_snippets_product_condition) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_product][condition]" name="seopress_pro_schemas[' . $id . '][rich_snippets_product][condition]" placeholder="' . esc_html__('e.g. NewCondition, UsedCondition...', 'wp-seopress-pro') . '" aria-label="' . __('Product Condition', 'wp-seopress-pro') . '" value="' . esc_html($check_product_condition) . '" />
            ...
            if ('manual_single' == $seopress_pro_rich_snippets_product_availability) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_product][availability]" name="seopress_pro_schemas[' . $id . '][rich_snippets_product][availability]" placeholder="' . esc_html__('e.g. InStock, InStoreOnly...', 'wp-seopress-pro') . '" aria-label="' . __('Product Availability', 'wp-seopress-pro') . '" value="' . esc_html($check_product_availability) . '" />
            ...
            if ('manual_single' == $seopress_pro_rich_snippets_product_positive_notes) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_product][positive_notes]" name="seopress_pro_schemas[' . $id . '][rich_snippets_product][positive_notes]" placeholder="' . esc_html__('e.g. Great design', 'wp-seopress-pro') . '" aria-label="' . __('Positive Notes', 'wp-seopress-pro') . '" value="' . esc_html($check_product_pros) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_product_negative_notes) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_product][negative_notes]" name="seopress_pro_schemas[' . $id . '][rich_snippets_product][negative_notes]" placeholder="' . esc_html__('e.g. Too expensive', 'wp-seopress-pro') . '" aria-label="' . __('Negative Notes', 'wp-seopress-pro') . '" value="' . esc_html($check_product_cons) . '" />
					</p>';
            }
        }
