            ...
            <div class="seopress-notice">
                ...
                <p>
                    <?php
                        ...
                        printf(__('You can also use the define %1$s to automatically activate your license key. <a href="%2$s" target="_blank">Learn more</a>', 'wp-seopress-pro'), '<code>SEOPRESS_LICENSE_KEY</code>', $docs['license']['license_define']);
                    ?>
                    ...
                    <tr valign="top">
                        ...
                        <td valign="top">
                            <input id="seopress_pro_license_key" name="seopress_pro_license_key" type="password"
                                autocomplete="off" spellcheck="false" autocorrect="off" autocapitalize="off" class="regular-text"
