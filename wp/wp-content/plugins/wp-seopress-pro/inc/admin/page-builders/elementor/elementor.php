        ...
        <# if ( data.field_type === 'text' ) { #>
            <?php if ('1' === seopress_get_toggle_option('ai')) { ?>
                <div class="elementor-control-input-wrapper" style="margin-bottom: 20px">
                    <button id="seopress_ai_generate_seo_meta" class="btn btnSecondary elementor-button elementor-button-default" data-lang="<?php if (function_exists('seopress_get_current_lang')) { echo seopress_get_current_lang(); }; ?>" type="button">
