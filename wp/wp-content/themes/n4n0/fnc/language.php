...
function get_ui_text($name, $lang = "auto"){
    ...
    $text = array(
      "lv" => array(
        ...
        "phone" => "+371 20431406",
        "work_hours" => "P. &mdash; Pk. 9:00 &mdash; 19:00 <br>S. Brīvdiena <br>Sv. Brīvdiena",
        ...
        "cart_delivery_deliver_info" => "Lūdzu, ievadiet savu adresi, mēs piegādājam tikai Latvijas robežās, ar dažādu kurjeru palīdzību, piegādes cena tiks aprēķināta, kad apstrādāsim Jūsu pasūtījumu.",
      ...
      "ru" => array(
        ...
        "address" => "Rīga, Mūkusalas iela 72b",
        "phone" => "+371 20431406",
        "work_hours" => "Пон. &mdash; Пят. 9:00 &mdash; 19:00 <br>С. Выходной <br>В. Выходной",
        "logo" => "Бардаль Латвия",
        "products" => "Продукты",
        "oil" => "Масло",
        "oils" => "Масла",
